...
def error_relativo(Input_vec_true, Input_vec_reco):
    ...
    for sig_linear in np.linspace( 0.2, 0.3, 101 ):
        for sig_mean in np.linspace( 0.4, 0.5, 101 ):

            vec_reco = Rule_smear( hist, Input_vec_true ).get_5for5_change( sig_linear, sig_mean, 1 )
...
if __name__ == '__main__':
    #error_different(In_minus_Nu_true, In_minus_Nu_reco)
    #print("\n")
    #error_multiple(In_minus_Nu_true, In_minus_Nu_reco) 
    #print("\n")
    #error_relativo(In_minus_Nu_true, In_minus_Nu_reco)

    
    Input_vec_true = In_minus_Nu_true
    Input_vec_reco = In_minus_Nu_reco
    ...
    vec_reco = Rule_smear( hist, Input_vec_true ).get_5for5_change( sigma_linear, sigma_mean, 1 )
