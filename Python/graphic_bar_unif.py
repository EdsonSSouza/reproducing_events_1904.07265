...
# Class that graphs histograms with uniform bins and joints (bin_UJ means bin Uniform and Joint)
    # Note: This function draws one type of graph on the article frame at a time, i.e. neutrino mode for tau_minus or tau_plus and so on.
...
# Class that graphs histograms with uniform bins and joints (bin_UJ means bin Uniform and Joint)
    # Note: This function draws all the graphs in the article frame, i.e. neutrino mode will have tau_minus and tau_plus and so on.
