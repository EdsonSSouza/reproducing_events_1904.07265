...
class S_matrix:
    ...
    def get_S_bm_SM(self):
        Nu_Flavor = 3                                                                                     # Number of flavor neutrinos

        Si_bm = np.zeros( (3,3), dtype=complex )

        auto_valor = np.zeros( (3), dtype=complex )                                                       # EigenValue
        Q_mod = np.zeros( (3,3), dtype=complex )                                                          # EigenVector
        M_prod = np.zeros( (3,3), dtype=complex )                                                         # Product matrix
