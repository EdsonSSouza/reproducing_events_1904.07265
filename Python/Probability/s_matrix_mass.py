...
class S_matrix:
    ...
    def base_mass(self):
        ...
        Hf_bm = Hamilton_matrix.input_data( self.cp_sign, self.en, self.V*1e9, self.instancia_U, self.instancia_M ).base_mass()
...
if __name__ == "__main__":
    ...
    Sf_bm = S_matrix.input_data( +1, 2, 1000, 2, matrix_PMNS, matrix_mass )
    print(f"\n{Sf_bm.base_mass()}\n") 
