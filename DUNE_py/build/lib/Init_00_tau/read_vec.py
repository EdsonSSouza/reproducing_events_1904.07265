...
def read_arq(name_arq:str) -> np.ndarray:
...
New_pre_MNu_Nu   = np.loadtxt( os.path.join(path_linux, 'New_pre_MNu_Nu.dat'  ) )                     # FAR_New-Pre-cal: MNu_Nu
New_pre_MNu_Anti = np.loadtxt( os.path.join(path_linux, 'New_pre_MNu_Anti.dat') )                     # FAR_New-Pre-cal: MNu_Anti
New_pre_MAn_Nu   = np.loadtxt( os.path.join(path_linux, 'New_pre_MAn_Nu.dat'  ) )                     # FAR_New-Pre-cal: MAn_Nu
New_pre_MAn_Anti = np.loadtxt( os.path.join(path_linux, 'New_pre_MAn_Anti.dat') )                     # FAR_New-Pre-cal: MAn_Anti
New_pre_MHE_Nu   = np.loadtxt( os.path.join(path_linux, 'New_pre_MHE_Nu.dat'  ) )                     # FAR_New-Pre-cal: MHE_Nu
...
New_Near_pre_MNu_Nu   = np.loadtxt( os.path.join(path_linux, 'New_Near_pre_MNu_Nu.dat'  ) )           # NEAR_Pre-cal: MNu_Nu
New_Near_pre_MNu_Anti = np.loadtxt( os.path.join(path_linux, 'New_Near_pre_MNu_Anti.dat') )           # NEAR_Pre-cal: MNu_Anti
New_Near_pre_MAn_Nu   = np.loadtxt( os.path.join(path_linux, 'New_Near_pre_MAn_Nu.dat'  ) )           # NEAR_Pre-cal: MAn_Nu
New_Near_pre_MAn_Anti = np.loadtxt( os.path.join(path_linux, 'New_Near_pre_MAn_Anti.dat') )           # NEAR_Pre-cal: MAn_Anti
New_Near_pre_MHE_Nu   = np.loadtxt( os.path.join(path_linux, 'New_Near_pre_MHE_Nu.dat'  ) )           # NEAR_Pre-cal: MHE_Nu
