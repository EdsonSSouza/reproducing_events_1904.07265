...
class Contour_bar:
    ...
    def get_plot( self, fac_alpha, str_color, str_style, width, str_label ):
...
class Graph_each:
    ...
    def __init__( self, type_mode:int, signal_tau:int, histogram, In_true:np.ndarray, In_reco:np.ndarray, Calc_reco:np.ndarray ):
    ...
    @classmethod
    def input_data(cls, type_mode:int, signal_tau:int, histogram, In_true:np.ndarray, In_reco:np.ndarray, Calc_reco:np.ndarray):
...
class Graph_each_HE:
    ...
    def __init__( self, histogram, In_true:np.ndarray, In_reco:np.ndarray, Calc_reco:np.ndarray ):
        self.hist      = histogram
        self.In_true   = In_true
        self.In_reco   = In_reco
        self.Calc_reco = Calc_reco
    @classmethod
    def input_data(cls, histogram, In_true:np.ndarray, In_reco:np.ndarray, Calc_reco:np.ndarray):
