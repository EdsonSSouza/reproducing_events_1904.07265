...
class Rule_smear:
    ...
    def __init__(self, histogram, event_true:np.ndarray, factor_linear:float, factor_mean:float, normalized:int ) -> None:
        self.hist    = histogram
    ...
    @classmethod
    def input_change( cls, factor_linear:float, factor_mean:float, normalized:int ):
