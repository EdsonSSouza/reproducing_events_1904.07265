...
if __name__== "__main__":
    ...
    if show == 1:
        Tab_Fit_2D.input_data( 0.307, 0.02195, 0.561, (177/180)*np.pi, 2.534*1e-3, 0*np.pi, 20 ).get_eps_alpha('DUNE_NSI_fit2D_WithBG_Eps_alpha')
        Tab_Fit_2D.input_data( 0.307, 0.02195, 0.561, (177/180)*np.pi, 2.534*1e-3, 1*np.pi, 20 ).get_eps_alpha('DUNE_NSI_fit2D_WithBG_PiEps_alpha')
